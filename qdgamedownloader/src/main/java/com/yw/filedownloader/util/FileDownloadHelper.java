 ...
 *
 * @see com.yw.filedownloader.FileDownloader#init(Context, OkHttpClientCustomMaker)
 */
public class FileDownloadHelper {
    ...
    public interface OkHttpClientCustomMaker {
         ...
         * @see com.yw.filedownloader.FileDownloader#init(Application, OkHttpClientCustomMaker)
         * @see OkHttpClient
         */
