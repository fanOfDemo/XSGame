 ...
 */
package com.yw.filedownloader.exception;
 ...
 * {@link com.yw.filedownloader.services.FileDownloadRunnable#getRandomAccessFile(boolean, long)}
 * The Chunked resource will be handled when the free space is not enough to store the following chunk:
 * {@link com.yw.filedownloader.services.FileDownloadRunnable#exFiltrate(Throwable)}
 */
