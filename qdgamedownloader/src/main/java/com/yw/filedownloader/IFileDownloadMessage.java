...
import com.yw.filedownloader.services.FileDownloadRunnable;
...
interface IFileDownloadMessage {
     ...
     *
     * @see com.yw.filedownloader.services.FileDownloadThreadPool
     */
    void notifyPending();
     ...
     *
     * @see com.yw.filedownloader.services.FileDownloadMgr#start(String, String, int, int, FileDownloadHeader)
     * @see com.yw.filedownloader.services.FileDownloadMgr#checkDownloading(String, String)
     */
    void notifyWarn();
     ...
     * @see com.yw.filedownloader.exception.FileDownloadHttpException
     * @see com.yw.filedownloader.exception.FileDownloadOutOfSpaceException
     * @see com.yw.filedownloader.exception.FileDownloadGiveUpRetryException
     */
    void notifyError();
